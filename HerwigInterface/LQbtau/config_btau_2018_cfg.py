...
print "file:"+str(options.files).split("'")[1]
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring("file:"+str(options.files).split("'")[1]),
)
...
process.GlobalTag = GlobalTag(process.GlobalTag, '106X_upgrade2018_realistic_v4', '')#FIXME
...
process.generator = cms.EDFilter("Herwig7GeneratorFilter",
    ...
    herwig7SingleLQ = cms.vstring(
        ...
        'setup S0bar 9941561 S0bar 400.0 0.0 0.0 0.0 -1 3 1 0', 
        'create /ThePEG/ParticleData S0', 
        'setup S0 -9941561 S0 400.0 0.0 0.0 0.0 1 -3 1 0', 
        'makeanti S0bar S0', 
